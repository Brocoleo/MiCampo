  ...
  return (
    <List sx={{ width: '100%', maxWidth: 550, bgcolor: 'background.paper' }}>
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Remy Sharp" src="/react-weather-app/icons/termometro.svg" />
        </ListItemAvatar>
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Travis Howard" src="/react-weather-app/icons/wind.svg" />
        </ListItemAvatar>
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Cindy Baker" src="/react-weather-app/icons/humidity.svg" />
        </ListItemAvatar>
